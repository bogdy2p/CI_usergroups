...
echo '<link href="' . base_url() . 'assets/css/jquery.tablesorter.pager.css"     rel="stylesheet"  type="text/css">';
echo '<link href="' . base_url() . 'assets/css/tablesorter_template.css"     rel="stylesheet"  type="text/css">';
