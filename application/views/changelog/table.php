...
<div class="row"> 
  <div class="changelogtablecontainer">
    ...
    foreach ($changelogs as $changelog) {
      $this->table->add_row(
          array('data' => '<' . $changelog['colour'] . '>' . $changelog['name'] . '</' . $changelog['colour'] . '>', 'class' => 'highlight col-xs-10 col-md-10 wordwrap1'), array('data' => $changelog['date'], 'class' => 'highlight col-xs-2 col-md-2 wordwrap1')
      );
    }
